...
@section('content')
    ...
    <section class="banner" style="background:none !important; overflow: hidden;">
        <div class="container">
            <div class="w-100 h-100 position-absolute"
                style=" z-index:-1; background-repeat:no-repeat; background-size:cover; height: 100%;  background-image: url('{{ asset('webasset/assets/images/Media.jpg') }}'); left: 0% ; top: -5% ;  ">
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="banner-content center-heading">
                        ...
                        <h1 style="font-family: Almarai;">{{ __('name_center') }}<br> <span class="fs-4 fw-bold"></span></h1>
                        <p style="font-family: 'Tajawal', sans-serif;">{{ __('description') }}</p>
                        <a href="{{ route('website.courses') }}" class="btn btn-main"><i class="fa fa-list-ul mr-2"></i>{{__('our Courses')}} </a>
                    </div>
                </div>
                        ...
                        <div class="category-item category-bg-{{$loop->iteration}}">
                            <a href="{{ route('website.category', $item->slug) }}">
                                <div class="category-icon">
                                   <img class="w-75 pb-1" src="{{asset('webasset/assets/images/logo-dark2-removebg-preview.png')}}" alt="">
                                </div>
                                <h4>{{ $item->trans_name }}</h4>
                                <p>({{ $item->courses->count() }} {{__('Courses')}})</p>
                            </a>
                        </div>
                    @endforeach
    ...
    <section class="section-padding popular-course pb-0">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="course-btn text-lg-right"><a href="{{ route('website.courses') }}" class="btn btn-main"><i
                                class="fa fa-store mr-2"></i> {{ __('All Courses')}}  </a></div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="about-img2">
                        <img src="{{ asset('webasset/assets/images/banner/banner-8.png') }}" alt="" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="section-heading">
    ...
    <section class="team section-padding bg-grey">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="team-item">
                        <img src="{{ asset('webasset/assets/images/team/team-4.jpg') }}" alt=""
                            class="img-fluid">
                        <div class="team-info">
                            <h4>Harish Ham</h4>
                            <p>CEO, Developer</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-item">
                        <img src="{{ asset('webasset/assets/images/team/team-1.jpg') }}" alt=""
                            class="img-fluid">
                        <div class="team-info">
                            <h4>Tanvir Hasan</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-item">
                        <img src="{{ asset('webasset/assets/images/team/team-2.jpg') }}" alt=""
                            class="img-fluid">
                        <div class="team-info">
                            <h4>Mikele John</h4>
                            <p>Content Writter</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-item">
                        <img src="{{ asset('webasset/assets/images/team/team-3.jpg') }}" alt=""
                            class="img-fluid">
                        <div class="team-info">
                            <h4>Mikele John</h4>
                            <p>Content Writter</p>
    ...
    <section class="blog section-padding">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item">
                        <img src="{{ asset('webasset/assets/images/blog/news-1.jpg') }}" alt=""
                            class="img-fluid">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item">
                        <img src="{{ asset('webasset/assets/images/blog/news-2.jpg') }}" alt=""
                            class="img-fluid">
                        <div class="blog-content">
                            <div class="entry-meta">
                                <span><i class="fa fa-calendar-alt"></i>May 19, 2020</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item">
                        <img src="{{ asset('webasset/assets/images/blog/news-3.jpg') }}" alt=""
                            class="img-fluid">
                        <div class="blog-content">
                            <div class="entry-meta">
                                <span><i class="fa fa-calendar-alt"></i>May 19, 2020</span>
